...
function checkemail(email)
{
    ...
    else
    {
        ...
        document.getElementById('email_error').innerText='email must be greater than 8 letters long'
    }
}
...
function   checkpassword(password)
{
    ...
    else
    {
        ...
        document.getElementById('password_error').innerText='password must be 8 letters long and should include (.) operator'
    }
}
